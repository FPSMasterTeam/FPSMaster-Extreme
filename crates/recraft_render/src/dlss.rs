...
impl Dlss {
    ...
    pub fn new(
        ...
        // NOT InvertedDepth — recraft uses standard depth (0=near), unlike Bevy's
        // reverse-Z.
    ...
    pub fn render(
        ...
        jitter: [f32; 2],
        reset: bool,
        // Render resolution `[w, h]` in texels: recraft's motion vectors are in UV
        ...
        let params = DlssSuperResolutionRenderParameters {
            ...
            // recraft's motion vectors are `cur_uv - prev_uv` in UV space; DLSS wants
