...
use fpsmaster_render::{text_height, text_width, GuiTexture, OverlayTextures, RenderStats, UiColor, UiFrame, UiRect};
...
/// fpsmaster seeds them from the server's UpdateHealth instead.
